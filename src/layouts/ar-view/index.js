...
function ARView() {
  ...
  const scenarios = [
    ...
    },
    {
      id: 6,
      title: "solar system",
      description: "Study the Solar System revolutions.",
      modelUrl: "/models/solarsystem1.glb",
      scale: "0.4 0.4 0.4",
      rotation: "0 0 0",
      position: "0 0 0",
    },
    {
      id: 7,
      title: "solar system",
      description: "Study  the solar system.",
    ...
    },
    {
      id: 8,
      title: "The Moon",
      description: "Study the surface of the MOON.",
    ...
    },
    {
      id: 9,
      title: "The MoonRover",
      description: "Study the surface of the MOON rover",
